...
const activeMenu = () => {
    ...
    menuItems.forEach((item) => {
        ...
        if (link && link.getAttribute("href") === "/shop") {
  ...
  return (
    <div className="relative w-full overflow-hidden font-display">
      ...
      >
        <div
          className="w-full flex-shrink-0 bg-hero_banner_one bg-no-repeat bg-cover
            bg-center fade-in"
        >
          <div className="container mx-auto flex flex-col justify-center h-full">
            <h1 className="text-3xl tracking-tight fade-left">New Season</h1>
            <p className="mt-4 text-6xl font-playfair font-bold text-grey fade-left">
              New arrivals
            </p>
            <div
              className="mt-[43px] inline-block fade-left"
              onClick={activeMenu}
            >
              <Link
                href={"/shop"}
        ...
        <div
          className="w-full flex-shrink-0 bg-hero_banner_two bg-no-repeat bg-cover
            bg-center fade-in"
        >
          <div className="container mx-auto flex flex-col justify-center h-full">
            <h1 className="text-3xl tracking-tight fade-left">New Season</h1>
        ...
        <div
          className="w-full flex-shrink-0 bg-hero_banner_three bg-no-repeat bg-cover
            bg-center fade-in"
        >
          <div className="container mx-auto flex flex-col justify-center h-full">
            <h1 className="text-3xl tracking-tight fade-left">New Season</h1>
      ...
      <button
        id="prev"
        className="absolute left-0 top-1/2 ml-0 md:ml-14 rotate-180"
      >
        <Image
          src={rightArrow}
